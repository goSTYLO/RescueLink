      ...
      listener: (context, authState) {
        if (authState is Authenticated) {
          ...
          if (step == AppFlowStep.signupLocation) {
            context
                .read<AppFlowBloc>()
                .add(const RegisterSuccessNavigateToPhoneVerify());
          } else if (step == AppFlowStep.signupPhoneEnterOtp) {
            context
                .read<AppFlowBloc>()
                .add(const OtpVerifiedNavigateToAccountCreated());
          } else if (step == AppFlowStep.residencyEnterOtp) {
            context
                .read<AppFlowBloc>()
                .add(const OtpVerifiedNavigateToDashboard());
          }
        }
          ...
          switch (flowState.step) {
              ...
              return VerifyDagupanResidencyScreen(
                ...
                onLocationVerificationFailed: () {
                  ...
                  ScaffoldMessenger.of(context).showSnackBar(
                    const SnackBar(
                      content: Text(
                          'You must be in Dagupan City to create an account'),
                      backgroundColor: Colors.red,
                    ),
                  );
                },
            ...
            case AppFlowStep.signupPhoneEnterOtp:
              return VerificationOtpScreen(
                phoneNumber: flowState.signupPhone ?? '',
                onBack: () =>
                    context.read<AppFlowBloc>().add(const SignUpPhoneOtpBack()),
            ...
            case AppFlowStep.residencyCheck:
              return VerifyDagupanResidencyScreen(
                onVerificationComplete: (lat, lng) {
                  context
                      .read<AppFlowBloc>()
                      .add(const SetResidencyVerificationStep('human'));
                },
                onRefreshGps: () {},
                selectedBarangay:
                    flowState.residencyBarangay ?? 'Barangay Poblacion Oeste',
              );
            ...
            case AppFlowStep.residencyRequestOtp:
              return VerificationScreen(
                onRequestOtp: () => context
                    .read<AppFlowBloc>()
                    .add(const SetResidencyVerificationStep('otp')),
                onBack: () => context
                    .read<AppFlowBloc>()
                    .add(const SetResidencyVerificationStep('back')),
                selectedBarangay:
                    flowState.residencyBarangay ?? 'Barangay Poblacion Oeste',
                cityRegion:
                    flowState.residencyCityRegion ?? 'Dagupan City, Pangasinan',
              );

            case AppFlowStep.residencyEnterOtp:
              return VerificationOtpScreen(
                phoneNumber:
                    flowState.residencyVerificationPhone ?? '+63 917 123 4567',
                onVerifyAndContinue: (_) {},
                onBack: () => context
                    .read<AppFlowBloc>()
                    .add(const SetResidencyVerificationStep('human')),
            ...
            case AppFlowStep.residencyOutsideArea:
              return OutsideServiceAreaScreen(
                onRetry: () => context
                    .read<AppFlowBloc>()
                    .add(const SetResidencyInsideDagupan(true)),
                onGoBack: () =>
                    context.read<AppFlowBloc>().add(const BackToLogin()),
              );
            ...
            case AppFlowStep.forgotPassword:
              return ForgotPasswordScreen(
                onBackToLogin: () =>
                    context.read<AppFlowBloc>().add(const BackToLogin()),
                onRequestCode: (phone) =>
                    context.read<AppFlowBloc>().add(SetForgotPhone(phone)),
              );
            ...
            case AppFlowStep.forgotVerifyNumber:
              return VerifyNumberScreen(
                ...
                onBack: () => context
                    .read<AppFlowBloc>()
                    .add(const SetForgotStep('forgot_password')),
              );
            ...
            case AppFlowStep.forgotVerified:
              return VerifiedScreen(
                onDone: () => context
                    .read<AppFlowBloc>()
                    .add(const SetForgotStep('create_new_password')),
              );
            ...
            case AppFlowStep.forgotIdentityError:
              return IdentityErrorScreen(
                onTryAgain: () => context
                    .read<AppFlowBloc>()
                    .add(const SetForgotStep('verify_number')),
              );
            ...
            case AppFlowStep.forgotCreateNewPassword:
              return CreateNewPasswordScreen(
                ...
                onBack: () => context
                    .read<AppFlowBloc>()
                    .add(const SetForgotStep('verified')),
                onResetPassword: (_) => context
                    .read<AppFlowBloc>()
                    .add(const SetForgotStep('password_updated')),
              );
            ...
            case AppFlowStep.signup:
              return SignUpScreen(
                onLoginTap: () =>
                    context.read<AppFlowBloc>().add(const ShowLogin()),
            ...
            case AppFlowStep.login:
              return LoginScreen(
                onSignUpTap: () =>
                    context.read<AppFlowBloc>().add(const ShowSignUp()),
                onSkip: () {},
                onForgotPasswordTap: () =>
                    context.read<AppFlowBloc>().add(const ShowForgotPassword()),
                onLogin: (phone, password) {
                  context
                      .read<AuthBloc>()
                      .add(LoginRequested(phone: phone, password: password));
                },
              );
          }
        },
